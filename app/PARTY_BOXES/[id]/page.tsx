...
import { PartyBox } from "../../constants";
            ...
            <div className="md:flex-1 px-4">
              <div className="rounded-lg bg-gray-300 dark:bg-gray-700 mb-4">
                <Image
                  ...
                  src={`/partyBoxes/${item.name}.png`}
                  alt={item.name as string}
                />
              </div>
              <div className="flex -mx-2 mb-4"></div>
            </div>
            <div className="md:flex-1 p-4 flex flex-col justify-between gap-12">
              <div className="flex flex-col gap-8">
                ...
                <div>
                  <span className="font-bold text-gray-700">Inclusions :</span>
                  {item?.Inclusions?.map((data: any) => (
                    <h1 key={data} className="text-gray-600 text-sm mt-2">
                      {data}
                    </h1>
                  ))}
                </div>
              ...
              <div className="flex flex-col gap-4 md:px-4">
                ...
                <div className="flex gap-10">
                  <Link
                    href="https://m.me/middlemistevents"
                    type="button"
                    data-te-ripple-init
                  ...
                  <Link
                    href="mailto:middlemistevent@gmail.com"
                    type="button"
                    data-te-ripple-init
                    data-te-ripple-color="light"
