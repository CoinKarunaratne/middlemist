      ...
      <div className="h-auto flex flex-col gap-16 align-middle items-center justify-center bg-[#FFEBEC] py-24">
        <div className="flex flex-col justify-center items-center gap-8 px-4 flex-1">
          ...
          <Paragraph size="sm" className=" text-slate-600 text-center">
            Rev up the excitement with our Cars Themed Party Supplies. From
            speedy plates to zooming cake toppers, every detail accelerates the
            fun. Drive your celebration into high gear with our Cars Collection.
            Start your engines and let the party race begin!
          </Paragraph>
        </div>
